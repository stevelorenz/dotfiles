...
return require("lazy").setup({
    ...
    {"dyng/ctrlsf.vim"}, -- Catppuccin colorscheme
    {"catppuccin/nvim"}, -- A Lua rewrite of vim-lastplace
    ...
    {"rcarriga/nvim-notify"}, -- Heuristically set buffer options
    {"tpope/vim-sleuth"},
    ...
    {"echasnovski/mini.animate"}, -- Work with trailing whitespace
    {"echasnovski/mini.trailspace"}, -- Automatically manage character pairs
